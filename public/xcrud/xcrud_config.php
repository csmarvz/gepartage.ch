<?php /** Configuration file; f0ska xCRUD v.1.6.22; 08/2014 */
class Xcrud_config
{
    // default connection
    public static $dbname = 'geneve_partage'; // Your database name
    public static $dbuser = 'geneve_partage'; // Your database username
    public static $dbpass = 'geneve_partage'; // // Your database password
